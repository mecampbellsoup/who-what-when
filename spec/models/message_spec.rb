...
describe Message do
  ...
  context "creating a message from a text message" do 
    ...
    before :each do 
      receiver.save
      @params = {"Body"=>"Body of the message in 30 seconds", "AccountSid"=>"AC", "MessageSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "ToZip"=>"11238", "ToCity"=>"BROOKLYN", "FromState"=>"CA", "ToState"=>"NY", "SmsSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "To"=>"+13476948027", "ToCountry"=>"US", "FromCountry"=>"US", "SmsMessageSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "ApiVersion"=>"2010-04-01", "FromCity"=>"ALHAMBRA", "SmsStatus"=>"received", "NumMedia"=>"0", "From"=>"+17403190208", "FromZip"=>"91006"}  
      @message = Message.create_from_sms(@params, receiver)
    end
