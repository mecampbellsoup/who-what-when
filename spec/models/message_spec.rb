...
describe Message do
  ...
  context "creating a message from a text message" do 
    before :each do 
      @params = {"AccountSid"=>"AC61028d6292b78640034237a1a8164b89", "MessageSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "Body"=>"Body of the message", "ToZip"=>"11238", "ToCity"=>"BROOKLYN", "FromState"=>"CA", "ToState"=>"NY", "SmsSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "To"=>"+13476948027", "ToCountry"=>"US", "FromCountry"=>"US", "SmsMessageSid"=>"SM37e06f9540c0943477d6a5ce974cc2fd", "ApiVersion"=>"2010-04-01", "FromCity"=>"ALHAMBRA", "SmsStatus"=>"received", "NumMedia"=>"0", "From"=>"+16262444636", "FromZip"=>"91006"}  
